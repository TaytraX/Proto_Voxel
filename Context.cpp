...
void Context::createSurface(HINSTANCE hinstance) {
...
SwapChainSupportDetails Context::querySwapChainSupport(VkPhysicalDevice physicalDevice) {
...
bool Context::isDeviceSuitable(VkPhysicalDevice physicalDevice) {
    QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
    bool               extensionsOk = checkDeviceExtensionSupport(physicalDevice);
...
void Context::createLogicalDevice() {
    ...
    createInfo.pEnabledFeatures = nullptr;              // <- corrigé
    createInfo.enabledExtensionCount = static_cast<uint32_t>(deviceExtensions.size());
    createInfo.ppEnabledExtensionNames = deviceExtensions.data();
    createInfo.pNext = &features2;
    createInfo.enabledLayerCount = 0;                   // <- corrigé
    createInfo.ppEnabledLayerNames = nullptr;            // <- corrigé
...
void Context::init(HWND hwnd, HINSTANCE hinstance) {
    this->hwnd = hwnd;
    createInstance();
    setupDebugMessenger();
...
void Context::createDepthImageView() {
    ...
    vkCreateImageView(device, &depthViewCI, nullptr, &depthImageView);
}
